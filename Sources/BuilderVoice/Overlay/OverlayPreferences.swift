...
public enum OverlayPreferences {
    public static let activeOverlayKey = "BuilderVoice.overlay.activeKind"
    public static let livePreviewEnabledKey = "BuilderVoice.overlay.livePreviewEnabled"
    public static let reduceMotionKey = "BuilderVoice.overlay.reduceMotion"
    ...
    public static let didChangeNotification = Notification.Name(
        "BuilderVoice.overlay.didChange"
    )
