...
enum HotKeyPreferences {
    private static let preferenceKey = "BuilderVoice.dictationHotKey"
    private static let pasteLastPreferenceKey = "BuilderVoice.pasteLastHotKey"
    private static let holdEnabledPreferenceKey = "BuilderVoice.holdToDictate.enabled"
    private static let holdKeyPreferenceKey = "BuilderVoice.holdToDictate.key"
