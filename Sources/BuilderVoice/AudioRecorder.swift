    ...
    AVCaptureAudioDataOutputSampleBufferDelegate
{
    ...
    private let captureQueue = DispatchQueue(
        label: "com.builderhelm.voice.audioCapture",
        qos: .userInitiated
    )
...
#if DEBUG
    private static let fixtureEnvironmentKey = "BUILDERVOICE_E2E_AUDIO_FILE"
    ...
    func start(
        ...
        let url = requestedURL
            ?? FileManager.default.temporaryDirectory
                .appendingPathComponent("buildervoice-\(UUID().uuidString)")
