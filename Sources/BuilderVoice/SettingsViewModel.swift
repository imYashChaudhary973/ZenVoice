...
final class SettingsViewModel: ObservableObject {
    ...
    @Published private(set) var showsBuilderVoiceAtAllTimes: Bool
    ...
    private static let accessibilityRequestedKey =
        "BuilderVoice.permissions.accessibilityRequested"
    ...
    init(
        ...
        showsBuilderVoiceAtAllTimes: Bool,
        ...
        self.showsBuilderVoiceAtAllTimes = showsBuilderVoiceAtAllTimes
    ...
    func setShowsBuilderVoiceAtAllTimes(_ enabled: Bool) {
        showsBuilderVoiceAtAllTimes = enabled
