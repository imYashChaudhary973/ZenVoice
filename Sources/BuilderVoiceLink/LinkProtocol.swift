...
import Foundation
#if canImport(BuilderVoiceCore)
import BuilderVoiceCore
#endif

/// Wire contract for the BuilderVoice cross-device link.
///
...
public enum BuilderVoiceLink {
    ...
    public static let bonjourServiceType = "_buildervoice-link._tcp"
...
public struct LinkHello: Codable, Equatable, Sendable {
    ...
    public init(
        protocolVersion: Int = BuilderVoiceLink.protocolVersion,
...
public enum LinkRefusal: String, Codable, Sendable {
    ...
    public var message: String {
        switch self {
        case .unsupportedProtocolVersion:
            return "This BuilderVoice companion speaks a different link version."
        case .notPaired:
...
public enum LinkCodec {
    ...
    public static func drain(
        ...
        while buffer.count >= headerSize {
            ...
            guard length > 0, length <= BuilderVoiceLink.maximumFrameBytes else {
