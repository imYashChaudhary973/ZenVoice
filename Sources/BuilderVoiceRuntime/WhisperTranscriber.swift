...
public final class WhisperTranscriber: @unchecked Sendable {
    ...
    private let configuration: BuilderVoiceConfiguration
    ...
    private func loadedContextLocked() throws -> OpaquePointer {
        ...
        // BuilderVoice runs on real Macs with hardware Metal. Hosted CI VMs can
        ...
        // BUILDERVOICE_DISABLE_GPU forces the CPU backend for those hosts.
        let cpuOnly =
            ProcessInfo.processInfo.environment["BUILDERVOICE_DISABLE_GPU"] == "1"
