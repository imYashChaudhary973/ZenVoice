...
/// compatibility remain in `BuilderVoiceConfiguration`.
public final class WhisperSpeechEngine: @unchecked Sendable, SpeechEngine {
    ...
    public init(configuration: BuilderVoiceConfiguration) {
        self.configuration = configuration
        self.transcriber = WhisperTranscriber(configuration: configuration)
        self.queue = DispatchQueue(
            label: "com.builderhelm.voice.whisper-\(configuration.modelID)",
            qos: .userInitiated
        )
    }
