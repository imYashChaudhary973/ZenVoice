...
public final class TextInserter {
    ...
    public enum ReplaceResult: Equatable {
        ...
        /// safely.
        case unsupported
        /// What is on screen is not what BuilderVoice put there — the user has
        /// typed, moved the caret, or switched fields.
        case mismatch
    }

    /// Replaces text BuilderVoice previously inserted with a corrected version.
    ///
    /// Deliberately does *not* simulate backspaces. Blind deletion assumes the
    /// caret is still where BuilderVoice left it, and if it is not the app happily
    ...
    public func insert(_ text: String) -> InsertResult {
        ...
        // pasteboard, nothing reached the app, and BuilderVoice said it had
        // worked.
