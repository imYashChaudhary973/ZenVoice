...
public enum RuntimeIdentityError: LocalizedError {
    ...
    public var errorDescription: String? {
        switch self {
        case .missingBundleIdentifier:
            return "BuilderVoice could not find a bundle identifier for this process."
        case .foreignBundleIdentifier(let identifier):
            return "BuilderVoice is running with an unrecognized bundle identifier: \(identifier)."
        }
    }
}
...
/// accepted. The initializer is internal so callers outside `BuilderVoiceCore`
...
/// Resolves the runtime identity of BuilderVoice so that tests, unsigned hosts,
...
///
/// The production identifier is `com.builderhelm.voice`. Any other
...
public enum RuntimeIdentity {
    ...
    public static let productionBundleID = "com.builderhelm.voice"
