...
public enum VerifiedModelCatalog {
    ...
    ///                               runtime; retired to keep BuilderVoice fully
    ...
    public static func modelsDirectory(
        ...
        return supportDirectory
            .appendingPathComponent("BuilderVoice", isDirectory: true)
    ...
    ///   used by `BuilderVoiceConfiguration.discover`. Size and modification date
    ...
    ///   all, which is precisely what `BuilderVoiceCoreChecks` proves when it
    ...
    private static func retiredParakeetModel() -> VerifiedModel {
        VerifiedModel(
            ...
            attribution:
                ...
                + "BuilderVoice because it requires the closed-source FluidAudio "
                + "runtime."
        )
    }


    /// Weights BuilderVoice converted itself, pinned by commit.
    ///
    ...
    /// conversion, BuilderVoice runs it and republishes the result — which means
    ...
    public static let convertedModelRepository =
        "https://huggingface.co/imYChaudhary22/buildervoice-hinglish-apex-ggml"
    ...
    private static func hinglishModel(
        ...
        VerifiedModel(
            ...
            attribution:
                ...
                + "GGML and quantized to q8_0 for BuilderVoice."
        )
    }
...
public enum ModelSelectionPreferences {
    public static let preferenceKey = "BuilderVoice.selectedModelID"
