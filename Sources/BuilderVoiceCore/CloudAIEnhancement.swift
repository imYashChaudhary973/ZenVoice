...
/// A hosted provider BuilderVoice can send a transcript to, when the user opts in.
///
...
/// The exact bytes BuilderVoice will send, built without touching the network.
///
...
/// The single seam through which BuilderVoice touches the network.
///
