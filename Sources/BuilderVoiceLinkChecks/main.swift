...
// BuilderVoiceLinkChecks — exercises the cross-device link over a real loopback
// TLS-PSK session.
//
...
print("BuilderVoiceLinkChecks: pairing keys and codes passed")
...
print("BuilderVoiceLinkChecks: framing passed")
...
require(
    welcome.protocolVersion == BuilderVoiceLink.protocolVersion,
    "welcome carried the wrong protocol version"
)
require(welcome.hostName == "BuilderVoice Checks", "welcome did not name the host")
require(
...
print("BuilderVoiceLinkChecks: paired session, ordering, and remote decision passed")
...
print("BuilderVoiceLinkChecks: high-risk approval stays on the Mac")
...
print("BuilderVoiceLinkChecks: replay window and bounded ring passed")
...
print("BuilderVoiceLinkChecks: policy gate and teardown passed")
print("BuilderVoiceLinkChecks: 6 checks passed")
