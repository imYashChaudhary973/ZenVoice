        ...
        ZenSection(title: "Default sub-mode") {
            ...
            ZenPanel {
                VStack(alignment: .leading, spacing: 6) {
                    ...
                    Text(
                        "In Rewrite, BuilderHelm Voice reads the current selection using Accessibility (or the clipboard as a fallback), applies your prompt through the Smart formatting rung, and shows a preview when the change is large."
                    )
