...
public final class HistoryPreferences {
    private enum Key {
        static let madeHistoryChoice = "BuilderVoice.history.madeChoice"
        static let historyEnabled = "BuilderVoice.history.enabled"
        static let hasEverEnabled = "BuilderVoice.history.hasEverEnabled"
        static let retainsFailedAudio = "BuilderVoice.history.retainsFailedAudio"
        static let retentionDays = "BuilderVoice.history.retentionDays"
        static let vaultNeedsVacuum = "BuilderVoice.history.vaultNeedsVacuum"
    }
