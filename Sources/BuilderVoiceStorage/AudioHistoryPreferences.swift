...
public final class AudioHistoryPreferences {
    private enum Key {
        static let madeChoice = "BuilderVoice.audioHistory.madeChoice"
        static let enabled = "BuilderVoice.audioHistory.enabled"
        static let maxSizeBytes = "BuilderVoice.audioHistory.maxSizeBytes"
        static let maxAgeDays = "BuilderVoice.audioHistory.maxAgeDays"
    }
