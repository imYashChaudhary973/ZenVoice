...
public enum DictationVaultError: LocalizedError {
    ...
    public var errorDescription: String? {
        ...
        case .database(let message):
            return "BuilderVoice history database failed: \(message)"
        case .missingRecord:
            return "The BuilderVoice history record no longer exists."
        case .invalidRecord:
            return "BuilderVoice found an invalid history record."
        }
    }
}
...
public actor DictationVault {
    ...
    public static func live(
        ...
        return try await DictationVault(
            databaseURL: dataDirectory.appendingPathComponent("BuilderVoice.sqlite"),
    ...
    public func recoverInterrupted(
        ...
        for entry in interrupted {
            ...
            try markFailed(
                id: entry.id,
                message: "BuilderVoice closed before this dictation completed.",
    ...
    private func encryptionContext(id: UUID, field: String) -> String {
        "BuilderVoice.dictation.v2|\(id.uuidString.lowercased())|\(field)"
    }

    private func correctionContext(id: UUID, field: String) -> String {
        "BuilderVoice.correction.v1|\(id.uuidString.lowercased())|\(field)"
    }
...
extension DictationVault: GoalRecordPersisting {
    ...
    private func agenticEncryptionContext(id: UUID) -> String {
        "BuilderVoice.agentic.v1.\(id.uuidString.lowercased())"
    }
}
