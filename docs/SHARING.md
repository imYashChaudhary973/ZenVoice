...
BuilderHelm Voice can turn four local insight metrics into a 1200×630 image:
...
or account information. The rendered card uses BuilderHelm Voice branding and a general
on-device privacy message.

## User-controlled flow

1. The user selects **Share Highlights** in Insights.
2. BuilderHelm Voice renders and shows the exact card preview locally.
...
BuilderHelm Voice does not choose a folder, sharing service, recipient, or audience. It
