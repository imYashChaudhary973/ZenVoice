...
// segment gap threshold by it to get the seconds gap between words. The "w"/"text"
...
// that fired during this call (0 if none). Per-event timestamps are available
...
// of a complete utterance (the user yielded the turn); <EOB> marks the end of
// a backchannel (a short acknowledgment like "uh-huh" while the other party
